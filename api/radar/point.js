...
export default async function handler(req,res){
  ...
  try{
    ...
    res.json({lat,lon,time:new Date(r.time*1000).toISOString(),hex:r.hex,dBZ:r.dBZ,rain_mm_per_h:+r.rain.toFixed(3),category:category(r.dBZ),attribution:"RainViewer",tile: frame.path+"/256/7/{x}/{y}/2/1_1.png"});
